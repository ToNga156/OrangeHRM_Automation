...
export class MyLeavePage extends BasePage {
    ...
    constructor(page: Page) {
        ...
        this.menuMyLeave = page.getByRole('link', {
            name: 'My Leave'
        });
        ...
        this.btnReset = page.getByRole('button', {
            name: 'Reset'
        });
        ...
        this.btnConfirmCancel = page.getByRole('button', {
            name: 'Yes, Confirm'
        });
    ...
    async verifySearchResultDisplayed(): Promise<void> {
        await expect(this.tblLeaveList)
            .toBeVisible();

        await expect(this.leaveRows.first())
            .toBeVisible();
    }
    ...
    async verifyNoRecordFound(): Promise<void> {
        await expect(this.lblNoRecordsFound)
            .toBeVisible();
    }
